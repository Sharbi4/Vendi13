      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Join VendiBook and start your journey</p>
          </div>
          ...
          <div className="mt-8 p-4 bg-slate-800/30 rounded-xl border border-slate-700">
            <h3 className="text-white font-medium mb-3 text-center">Why join VendiBook?</h3>
            <ul className="space-y-2 text-sm text-slate-300">
              <li className="flex items-center gap-2">
                <span className="text-[#FF5124]">✓</span>
                Browse food trucks, trailers & ghost kitchens
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#FF5124]">✓</span>
                Book rentals or purchase equipment
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#FF5124]">✓</span>
                List your own assets and earn money
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#FF5124]">✓</span>
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-400 text-sm">
              ...
              <Link to="/sign-in" className="text-[#FF5124] hover:text-[#e5481f] font-medium">
                Sign in
              </Link>
            </p>
          </div>
